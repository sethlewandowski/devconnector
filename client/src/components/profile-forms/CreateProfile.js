...
import { Link, withRouter } from 'react-router-dom'; //allows redirect from action
...
const CreateProfile = ({ createProfile, history }) => {
  ...
  const [displaySocialInputs, toggleSocialInputs] = useState(false); //default is false
    ...
    <Fragment>
      ...
      <form className='form' onSubmit={(e) => onSubmit(e)}>
        ...
        <div className='form-group'>
          ...
          />
          <small className='form-text'>
            Please use comma separated values (eg. Marketing, Javascript,
            Product Development)
          </small>
        </div>
        <div className='form-group'>
